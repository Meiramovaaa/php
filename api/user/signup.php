<?php
    ...
    $_POST["full_name"], $_POST["password"],
    $_POST['password2']) &&
    ...
    strlen($_POST['password2']) > 0){
        ...
        mysqli_stmt_bind_param($prep, "ss", $nickname, $email);
        mysqli_stmt_execute($prep);
        $old_user = mysqli_stmt_get_result($prep);
        ...
        VALUES(?, ?, ?, ?)");
        mysqli_stmt_bind_param($prepare, "ssss", $email,  $nickname, $full_name, $hash);
